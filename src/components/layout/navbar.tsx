...
function NavbarInner({
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center pointer-events-auto ml-4 md:ml-32">
                {/* Profile Picture - Dynamic 36px -> 40px transition */}
            ...
            <div className="flex flex-col items-center gap-1 pointer-events-auto relative">
                <div className="flex items-center gap-4">
                    ...
                    >
                                    ...
                                    >
                                        ...
                                        <div className="relative flex items-center justify-center w-[6px] h-[6px]">
                                            ...
                                            <Link
                                                ...
                                                className="text-[14px] font-bold tracking-[0.2em] uppercase opacity-50 hover:opacity-100 transition-opacity absolute right-[12px] whitespace-nowrap z-20 pointer-events-auto"
                                                style={{ color: textColor, fontFamily: 'var(--font-post-no-bills)' }}
                                            >
                                                {node1_Left.label}
                                            </Link>
                                        ...
                                        <div className="relative flex items-center justify-center w-[6px] h-[6px]">
                                            ...
                                            <Link
                                                href="/playground"
                                                className="text-[14px] font-bold tracking-[0.2em] uppercase opacity-50 hover:opacity-100 transition-opacity absolute left-[12px] whitespace-nowrap z-20 pointer-events-auto"
                        ...
                        >
                            {isAbout || isProjects ? (
                                ...
                                <svg width="48.45" height="15.25" viewBox="0 0 49 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: textColor }}>
                    ...
                    {/* Scroll Progress Bar */}
                    <div className="w-[100px] md:w-[200px] h-[4px] relative rounded-[2px] overflow-hidden bg-black">
                        <div
                            className="h-full bg-[#ccff00] relative z-10 w-[var(--scroll-w)]"
                        />
                    </div>
                </div>
            </div>
