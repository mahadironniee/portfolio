...
const fsSource = `
    ...
    void main() {
        ...
        vec3 neutralSmokeColor = vec3(0.1, 0.1, 0.1); // Subtle dark grey smoke
        
        // The smoke intensity is tied to u_opacity so it fades in naturally
        float smokeMix = internalSmoke * 0.75 * u_opacity;
        
        // Blend base color with neutral smoke
        vec3 finalColor = mix(baseColor, neutralSmokeColor, smokeMix);
        // Add slight additive glow for the smoke highlights
        finalColor += neutralSmokeColor * (smokeMix * 0.3);
